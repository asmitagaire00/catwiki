...
const HeroBottomCard = () => {
  return (
    <div className="bg-[#E3E1DC] pl-4 pr-4 pt-4 md:pl-12 md:pr-12 w-full">
      ...
      <div className="mb-5 md:mb-10 flex  justify-between">
        <p className="text-lg font-bold md:text-[30px] lg:text-[40px] text-[rgba(41, 21, 7, 0.6)]">
          66+ breeds for you to discover
        </p>
        <div className="flex">
          <p className="hidden md:text-lg md:text-[rgba(41, 21, 7, 0.6)] md:inline-block  md:mr-2">
            See More
          </p>
          <div className="hidden md:inline-block divt-[4px]">→</div>
        </div>
      </div>
      <div className="flex flex-wrap ">
        <div className=" mr-6 mb-4 md:flex-1">
          <img
